...
import type { Manifest, Project } from '@forgelink/shared';
...
export class Publisher {
  private readonly logger = createLogger('builder:publish');
  ...
  async publishAll(project: Project, outputDir: string): Promise<void> {
